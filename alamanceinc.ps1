...
"@
curl.exe --silent -X "POST" -H "accept: text/plain" -H "authorization: Basic $api" -H "Content-Type: application/json" -d "{\"Email\":\"demokorplink@alamanceinc.com\",\"Identifier\":\"$name\"}" "https://api.korplink.com/api/v1/provisioning/peers" -o "C:\kpl.conf"
